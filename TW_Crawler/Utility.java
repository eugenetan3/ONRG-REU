...
public class Utility{
    ...
    public static void buildTables(List<String> al_tables, DatabaseManager dm){
        ...
        if(al_tables.size() > 3){
            /* Stop crating FoFr, because amu Saed is collecting the FoFr separately */
