...
public class DatabaseManager{
	...
	//public String[] sattr = {"tweet_id", "text", "time_created","is_reply","is_retweet","retweet_count","favorite_count","user_id","in_reply_to_sid", "in_reply_to_uid","is_truncated","is_possibly_sensitive","geo_location","lang","time_collected"};		//15
	public String[] sattr;
